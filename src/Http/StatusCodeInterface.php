...
use Fig\Http\Message\StatusCodeInterface as FigStatusCodeInterface;

interface StatusCodeInterface extends FigStatusCodeInterface
{
    // [Informational 1xx]

    // [Successful 2xx]
    public const STATUS_NONAUTHORITATIVE_INFORMATION = 203;

    // [Redirection 3xx]
    public const STATUS_UNUSED = 306;
    ...
    public const STATUS_POLICY_NOT_FULFILLED = 420;
    public const STATUS_MISREDIRECTED_REQUEST = 421;
    public const STATUS_UNORDERED_COLLECTION = 425;
    ...
    public const REASON_PHRASES = [
        ...
        self::STATUS_NONAUTHORITATIVE_INFORMATION    => 'Non-Authoritative Information',
        ...
        self::STATUS_METHOD_NOT_ALLOWED              => 'Verb Not Allowed',
        ...
        self::STATUS_POLICY_NOT_FULFILLED            => 'Policy Not Fulfilled',
        self::STATUS_MISREDIRECTED_REQUEST           => 'Misredirected Request',
